...
model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_strides=[4, 8, 16, 32, 46],#修改anchor的大小
...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
optimizer = dict(type='SGD', lr=0.02, momentum=0.9, weight_decay=0.0001) #一张卡要变成0.0025 8张卡是0.02
...
log_level = 'INFO'
work_dir = './work_dirs/cancer/libra_cascade_rcnn_r34_fpn_2x_a_d'
load_from = None
resume_from = None
workflow = [('train', 1)]
