...
model = dict(
    type='CascadeRCNN',
    num_stages=3,
    pretrained='/home/admin/jupyter/yhq/mmdetection-medical_match/models/resnet34.pth',
    backbone=dict(
        type='ResNet',
        depth=34,
        num_stages=4,
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1600, 1600),(800,800)], keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(800,800),(1024,1024),(1200,1200),(1600, 1600)],
        flip=True,
        transforms=[
...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
#一张卡要变成0.0025 8张卡是0.02 2张卡是0.005
...
log_level = 'INFO'
work_dir = './work_dirs/cancer_final/cascade_rcnn_r34_fpn_1x_small800'
#'./work_dirs/cancer_final/cascade_rcnn_r34_fpn_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]
