...
if __name__ == "__main__":
    ...
    cancer_path = "/media/hero-y/机械盘T1/Tianchi/medicine/crops/annotation_tmp/"
    saved_coco_path ="/media/hero-y/机械盘T1/Tianchi/medicine/crops/annotations/"
